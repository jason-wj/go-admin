  ...
  <el-container class="layout-cont">
    <el-container :class="[isSider?'openside':'hideside',isMobile ? 'mobile': '']">
      ...
      <el-aside class="main-cont main-left">
        <div class="tilte" :style="{background: userStore.backgroundColor}">
          <img alt class="logoimg" :src="$GIN_VUE_ADMIN.appLogo">
          <h2 v-if="isSider" class="tit-text" :style="{color:userStore.baseColor}">{{ $GIN_VUE_ADMIN.appName }}</h2>
        </div>
        <Aside class="aside" />
      </el-aside>
      <!-- 分块滑动功能 -->
                            ...
                            <el-dropdown-menu class="dropdown-group">
                              <el-dropdown-item>
                                <span style="font-weight: 600;">
                                  {{ t('layout.currentRole') }}{{ userStore.userInfo.role.roleName }}
                                </span>
                              </el-dropdown-item>
...
<script setup>
import Aside from '@/view/sys/layout/aside/index.vue'
import HistoryComponent from '@/view/sys/layout/aside/historyComponent/history.vue'
import Search from '@/view/sys/layout/search/search.vue'
import BottomInfo from '@/view/sys/layout/bottomInfo/bottomInfo.vue'
