<template>
  <div>
        ...
        <div class="fl-left avatar-box">
          <div class="user-card">
            ...
            <div class="user-personality">
              ...
              <p class="person-info"> {{ userStore.userInfo.post.postName }}</p>
            </div>
            <div class="user-information">
              <ul>
                ...
                <el-tooltip
                  class="item"
                  effect="light"
                  :content="userStore.userInfo.dept.deptName"
                  placement="top"
                >
                  <li>
                    <el-icon>
                    ...
                    {{ userStore.userInfo.dept.deptName }}
                  </li>
                </el-tooltip>
                <li>
                  <el-icon>
                  ...
                  {{ userStore.userInfo.role.roleName }}
                </li>
                <el-tooltip
                  class="item"
                  effect="light"
                  :content="userStore.userInfo.createdAt"
                  placement="top"
                >
                  <li>
                    <el-icon>
    ...
    <el-dialog v-model="changePhoneFlag" title="绑定手机" width="600px" append-to-body destroy-on-close>
      <el-form :model="phoneForm">
        ...
        <el-form-item label="验证码" label-width="120px">
          <div class="code-box">
            <el-input v-model="phoneForm.code" autocomplete="off" placeholder="短信功能暂不实现，请随意输入" style="width:300px" />
    ...
    <el-dialog v-model="changeEmailFlag" title="绑定邮箱" width="600px" append-to-body destroy-on-close>
...
import { updateSelfPhone, updateSelfEmail, updateSelfNickName, setSelfInfo, changePassword } from '@/api/sys/user.js'
...
const enterEdit = async() => {
  const res = await updateSelfNickName({
...
const changePhone = async() => {
  const res = await updateSelfPhone({ phone: phoneForm.phone })
  if (res.code === 200) {
    ElMessage.success(res.msg)
...
const changeEmail = async() => {
  const res = await updateSelfEmail({ email: emailForm.email })
  if (res.code === 200) {
    ElMessage.success(res.msg)
