        ...
        <div class="gva-top-card-left">
          ...
          <div>
            <div class="gva-top-card-left-item">
              {{ t('view.dashboard.website') }}
              <a
                style="color:#409EFF"
                target="view_window"
                href="http://www.wjblog.top"
              >http://www.wjblog.top</a>
            </div>
            <div class="gva-top-card-left-item">
              {{ t('view.dashboard.sourceUrl') }}
              <a
                style="color:#409EFF"
                target="view_window"
                href="https://github.com/jason-wj/go-admin"
              >https://github.com/jason-wj/go-admin</a>
            </div>
          </div>
        </div>
...
<script setup>
import echartsLine from '@/view/sys/dashboard/dashboardCharts/echartsLine.vue'
import dashboardTable from '@/view/sys/dashboard/dashboardTable/dashboardTable.vue'
import { ref } from 'vue'
