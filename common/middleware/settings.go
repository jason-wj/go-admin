...
var CasbinExclude = []UrlInfo{
	...
	{Url: "/admin-api/v1/gen/apitofile/:tableId", Method: "GET"},
	{Url: "/admin-api/v1/getCaptcha", Method: "GET"},
	{Url: "/admin-api/v1/getinfo", Method: "GET"},
	...
	{Url: "/admin-api/v1/user/profile", Method: "GET"},
	{Url: "/info", Method: "GET"},
	{Url: "/admin-api/v1/login", Method: "POST"},
	{Url: "/admin-api/v1/logout", Method: "POST"},
	{Url: "/admin-api/v1/user/avatar", Method: "POST"},
	{Url: "/admin-api/v1/user/pwd", Method: "PUT"},
	{Url: "/admin-api/v1/metrics", Method: "GET"},
	{Url: "/admin-api/v1/health", Method: "GET"},
	{Url: "/", Method: "GET"},
	{Url: "/admin-api/v1/server-monitor", Method: "GET"},
	{Url: "/admin-api/v1/public/uploadFile", Method: "POST"},
}
