...
func (e Gen) Preview(c *gin.Context) {
	...
	mp["static/template/authdto.go.template"] = b6.String()
...
func (e Gen) NOActionsGen(c *gin.Context, tab tools.SysTables) {
	...
	_ = pkg.PathCreate("./app/" + tab.PackageName + "/service/authdto/")
	...
	pkg.FileCreate(b6, "./app/"+tab.PackageName+"/service/authdto/"+tab.TBName+".go")
