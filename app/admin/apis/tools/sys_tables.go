...
// @Router /admin-api/v1/sys/tables/page [get]
...
// @Success 200 {object} response.Response "{"code": 200, "data": [...]}"
// @Router /admin-api/v1/sys/tables/info/{tableId} [get]
// @Security Bearer
...
// @Router /admin-api/v1/sys/tables/info [post]
// @Security Bearer
...
// @Router /admin-api/v1/sys/tables/info/{tableId} [delete]
